...
void propiedades(int NNN, type_real *fof)
{
  ...
  for(i=0;i<NTHREADS;i++)
  {
    ...
    #ifdef MCRITIC
    sprintf(filename,"%.2d_%.4d_densidad_pares_cut_%.2f_%.2f_%.2f.%.2d.bin",snap.num,NNN,m_critica,fof[0],fof[1],i);
    #else
    sprintf(filename,"%.2d_%.4d_densidad_pares_%.2f_%.2f.%.2d.bin",snap.num,NNN,fof[0],fof[1],i);
    #endif
    ...
    #ifdef CALCULA_MEDIA
      #ifdef MCRITIC
        sprintf(filename,"../%.2d_%.4d_vmedia_pares_cut_%.2f_%.2f_%.2f.%.2d.bin",snap.num,NNN,m_critica,fof[0],fof[1],i);
      #else
        sprintf(filename,"../%.2d_%.4d_vmedia_pares_%.2f_%.2f.%.2d.bin",snap.num,NNN,fof[0],fof[1],i);
      #endif
    ...
    #ifdef SAVEPART
       #ifdef MCRITIC
         sprintf(filename,"%.2d_%.4d_particulas_pares_cut_%.2f_%.2f_%.2f.%.2d.bin",snap.num,NNN,m_critica,fof[0],fof[1],i);
       #else
         sprintf(filename,"%.2d_%.4d_particulas_pares_%.2f_%.2f.%.2d.bin",snap.num,NNN,fof[0],fof[1],i);
       #endif
    ...
    #ifdef EXTEND
      #ifdef MCRITIC
      sprintf(filename,"%.2d_%.4d_extend_pares_cut_%.2f_%.2f_%.2f.%.2d.bin",snap.num,NNN,m_critica,fof[0],fof[1],i);
      #else
      sprintf(filename,"%.2d_%.4d_extend_pares_%.2f_%.2f.%.2d.bin",snap.num,NNN,fof[0],fof[1],i);
      #endif
