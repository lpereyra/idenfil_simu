	subroutine arvo(ns,sph,V)
c     Computing surface area and volume of the overlapping spheres
	implicit real*8(a-h,o-z)
	parameter (pi=3.14159265358979323846264d0,ks=3000,kl=300,ka=3000,
	1           ki=100000)
...
c
	do i=1,ns
	  spheres(i,1) = sph(4*(i-1)+1)
		spheres(i,2) = sph(4*(i-1)+2)
		spheres(i,3) = sph(4*(i-1)+3)
		spheres(i,4) = sph(4*(i-1)+4)
	enddo
